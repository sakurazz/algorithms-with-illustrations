...
| [Disjoint Set](https://github.com/willwang-x/algorithms-with-illustrations/blob/master/cornerstone/union-find.md)| 🌟[547. Friend Circles](https://leetcode.com/problems/friend-circles/)<br><br> x, 👻[130 regions](https://leetcode.com/problems/surrounded-regions/), 👹[803 falling](https://leetcode.com/problems/bricks-falling-when-hit/) |  <img src="https://i.imgur.com/OldUfa1.jpg" alt="disjoint set / union-find" width="200"/> <br> by [Union Find](https://www.youtube.com/watch?v=0jNmHPfA_yE) | |
